window.STOKENGINEER_DATA = {
 "meta": {
  "version": "0.4.0",
  "generated_at": "2026-09-22T23:12:58+00:00",
  "git_revision": "9404a80",
 ...
 "demo": [
  {
   ...
   "notes": [
    ...
    "lineup_1: simulated ROI 205% with a 28% cash rate. A cash rate near the paid fraction cannot justify that ROI unless the lineup is winning top prizes far more often than the field. Check (1) the field model, (2) whether the lineups were built on info the field lacked, (3) the payout structure.",
 ...
 "reports": [
  {
   ...
   "provenance": {
    ...
    "generated_at_utc": "2026-09-23T00:13:24+00:00",
    "notes": [
  ...
  },
  {
   ...
   "provenance": {
    ...
    "engine_version": "0.4.0",
    "generated_at_utc": "2026-09-23T00:12:54+00:00",
    "notes": [
     "Sample slates in src/data/samples are synthetic and labelled as such. They exist so the engine can be tested deterministically offline; they are not real salaries or real projections, and no report generated from them describes real players."
    ],
  ...
  },
  {
   ...
   "provenance": {
    ...
    "engine_version": "0.4.0",
    "generated_at_utc": "2026-09-23T00:12:47+00:00",
    "notes": [
     ...
     "lineup_1: simulated ROI 306% with a 35% cash rate. A cash rate near the paid fraction cannot justify that ROI unless the lineup is winning top prizes far more often than the field. Check (1) the field model, (2) whether the lineups were built on info the field lacked, (3) the payout structure.",
     "payout structure is illustrative, so ROI is a ranking aid only",
     "payout structure is ILLUSTRATIVE: supply the real contest payout (CSV) before treating any ROI here as expected money",
     "Sample slates in src/data/samples are synthetic and labelled as such. They exist so the engine can be tested deterministically offline; they are not real salaries or real projections, and no report generated from them describes real players."
    ],
    "payload_sha256": "bad1ed2deff9ebaafce4b39b6ec6de603186f185512caac503ad46889bec5c99",
    "platform": "Linux-6.1.158+-x86_64-with-glibc2.36",
    "python": "3.11.2",
    "sources": [
     {
